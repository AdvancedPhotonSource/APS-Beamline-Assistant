    ...
    def __init__(self):
        ...
        self.available_models = {
            ...
            "Anthropic": {
                ...
                "claudeopus4":   "Claude Opus 4 (200K ctx, 32K out)",
                "claudesonnet46":"Claude Sonnet 4.6 (200K ctx, 64K out) — no temp/top_p",
                "claudesonnet45":"Claude Sonnet 4.5 (200K ctx, 64K out) — no temp/top_p",
                "claudesonnet4": "Claude Sonnet 4 (200K ctx, 64K out)",
                "claudesonnet37":"Claude Sonnet 3.7 (200K ctx, 128K out)",
                "claudehaiku45": "Claude Haiku 4.5 (200K ctx, 64K out) — no temp/top_p",
            },
            "Google": {
                "gemini25pro":   "Gemini 2.5 Pro (1M ctx, 65K out)",
                "gemini25flash": "Gemini 2.5 Flash (1M ctx, 64K out)",
            }
        }
